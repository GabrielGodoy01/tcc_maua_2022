...
mixin _$RelatoriosController on RelatoriosControllerBase, Store {
  late final _$listaItensEstoqueAtom = Atom(
      name: 'RelatoriosControllerBase.listaItensEstoque', context: context);
  ...
  late final _$obterTodosEstoqueAsyncAction = AsyncAction(
      'RelatoriosControllerBase.obterTodosEstoque',
      context: context);
